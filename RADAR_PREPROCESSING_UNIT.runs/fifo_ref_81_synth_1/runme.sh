...
HD_PWD='C:/Users/ramon/Documents/GITHUB/RADAR_PREPROCESSING_UNIT/RADAR_PREPROCESSING_UNIT.runs/fifo_ref_81_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ref_81.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_ref_81.tcl
