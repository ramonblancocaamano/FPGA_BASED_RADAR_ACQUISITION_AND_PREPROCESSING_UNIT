...
HD_PWD='C:/Users/ramon/Documents/GITHUB/FPGA_BASED_RADAR_ACQUISITION_AND_PREPROCESSING_UNIT/FPGA_BASED_RADAR_ACQUISITION_AND_PREPROCESSING_UNIT.runs/fifo_81_50_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_81_50.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_81_50.tcl
