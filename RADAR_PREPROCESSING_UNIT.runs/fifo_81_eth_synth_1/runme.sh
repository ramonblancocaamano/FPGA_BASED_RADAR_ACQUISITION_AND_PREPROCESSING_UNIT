...
HD_PWD='C:/Users/ramon/Documents/GITHUB/FPGA_BASED_RADAR_ACQUISITION_AND_PREPROCESSING_UNIT/FPGA_BASED_RADAR_ACQUISITION_AND_PREPROCESSING_UNIT.runs/fifo_81_eth_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_81_eth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_81_eth.tcl
