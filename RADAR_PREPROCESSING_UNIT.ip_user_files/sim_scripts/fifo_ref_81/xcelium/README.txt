...
#
# Generated by export_simulation on Sat Jan 11 17:28:40 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './fifo_ref_81.sh' script.

./fifo_ref_81.sh -reset_run
...
./fifo_ref_81.sh -noclean_files

For more information on the script, please type './fifo_ref_81.sh -help'.
